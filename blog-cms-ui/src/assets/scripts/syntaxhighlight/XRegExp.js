...
if (!XRegExp) {
  ...
  // `execAll` removed in XRegExp 1.2.0 when I realized it is trivial to implement using
  // `forEachExec`. Uncomment this block if you want the method back
  /*RegExp.prototype.execAll = function (str) {
   var result = [];
   this.forEachExec(str, function (match) {
   result.push(match);
   });
   return result;
   };*/
